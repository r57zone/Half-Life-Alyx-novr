...
End | Бросок энергетического шара (глава 11: Отбытие), если не работает попробуйте нажать быстро несколько раз или поставить "DebugMode" - true в конфиге "default.vrsettings" | Движение левого контроллера
