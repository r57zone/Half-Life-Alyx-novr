...
В настройках игры необходимо выбрать хождение на тачпаде (для плавного хождения как в обычных играх).



**Внимание!** Во время игры происходит центрирование мыши, чтобы выключить его нажмите клавишу "Escape", для возобновления центрирования нажмите "F7".
## Управление
