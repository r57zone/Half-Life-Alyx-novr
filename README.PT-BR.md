...
Você também pode usar drivers de terceiros para capacetes VR feitos de um smartphone, para isso você precisa alterar o parâmetro `HMD` para `0` no arquivo de configuração "...\Steam\steamapps\common\SteamVR\drivers\ hlalyx\HalfLifeAlyx.ini" e instale o driver SteamVR necessário para o capacete, por exemplo, [OpenVR-OpenTrack](https://github.com/r57zone/OpenVR-OpenTrack), [OpenVR-OpenVR-ArduinoHMD](https://github.com/r57zone/OpenVR-ArduinoHMD ) ou algum outro, e também altere o perfil do botão para "Mobile and DIY VR with HMD rotation", no qual os botões esquerdo e direito são feitos para rotações do jogador.
